<div>
    ...
    <form wire:submit.prevent="AgregarProductor">

        <fieldset class="fieldset bg-base-200 border-base-300 rounded-box w-full border p-4">
            <legend class="fieldset-legend">Agregar Productor</legend>            
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <select class="select appearance-none bg-base-100" wire:model="localidad_id">
                ...
                <div>
                    ...
                    <select class="select appearance-none bg-base-100" wire:model="semana">
            ...
            <div>
                ...
                <x-localidad.boton-guardar target="AgregarProductor" texto="Guardar" />
            </div>
